...
<div class="main-dashboard">
        ...
        @if($categories)
          @foreach($categories as $category)
             <div class="col-md-3 pr-0 pl-0">
              <a href="#">
              <div class="single-cate" style="background-image: url({{asset('uploads/categories/' . $category->cate_image)}});background-repeat: no-repeat;background-size: cover;">
    ...
    <section class="trending-posts-area mt-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Section Heading -->
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        ...
                        <div class="post-thumbnail">
                            <img style="height: 162px;" src="{{asset('uploads/posts/' . $post->image)}}" alt="">
                        </div>

                        <!-- Post Content -->
                        <div class="post-content">
                            <a href="#" class="post-cata cata-sm cata-success">{{$post->category->title}}</a>
                            <a href="{{route('user.posts.single',$post->id)}}" class="post-title">{{$post->title}}</a>
