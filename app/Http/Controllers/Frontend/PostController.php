...
class PostController extends Controller
{
  ...
  public function myposts(){
      return view('frontend.posts.myposts');
  }

  public function create(){
    $cates=Category::where('status','=','activated')->get();
    $tags=Tag::all();
  ...
  public function singlePost($post_id){
    ...
    $relatedPosts=Post::where('category_id','=',$post->id)->get();
    $categories=Category::all();
    $mainComments=$post->comments->where('parent_id','=','0');
    $subComments=$post->comments->where('parent_id','!=','0',);

    return view('frontend.posts.single-post',['post'=>$post,
    ...
    $validator=Validator::make($request->all(),[
     ...
     if($validator->fails()){
        ...
        $request->image->move($path,$file_name);
            ...
            return response()->json(['status'=>201,'msg'=>'post not create successfully']);
            }
